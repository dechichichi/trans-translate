...
class MultiHeadAttention(Module):
    def _init_(self,
        ...
        # 检查word_emb_dim是否可以被nheads整除
        assert self.head_dim * nheads == word_emb_dim
        # Q K V全连接层
    ...
    def forward(self,
        ...
        #获取query、key、value的形状
        tgt_len, batch_size, embed_dim = query.size()
        num_heads = self.num_heads
        assert embed_dim == self.word_emb_dim
